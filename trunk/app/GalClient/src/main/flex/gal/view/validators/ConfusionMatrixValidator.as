package gal.view.validators
{
	...
	public class ConfusionMatrixValidator extends Validator
	{
		...
		override protected function doValidation(value:Object) : Array{
			...
			{
				if (!validateNumber(confusionMatrixRow.adenine) ||
					!validateNumber(confusionMatrixRow.cytosine) ||
					!validateNumber(confusionMatrixRow.guanine) ||
					!validateNumber(confusionMatrixRow.thymine))
				{
		...
		private function validateNumber(value:Number):Boolean{
			if (isNaN(value) ||
				...
				value == Number.POSITIVE_INFINITY) return false;
			else return true;
